...
def body0():
	...
	p = 0
	numIter = 40
	workbook = xlsxwriter.Workbook("report_orange4home_f" + str(2) + ".xlsx")
				...
				for mon in [30]:
					...
					for crash in crList:
						...
						while(i < numIter):
							...
							s4 = subprocess.getstatusoutput("python3 monitor.py " + str(mon)+ " orange4home_newf" + str(num) + "-3.txt " + str(crash) + " " + str(kRound) + " " + dist + " " + str(p))
...
def body2(num, mon, crash):
	...
	while (i < 20):
		...
		s2 = subprocess.getstatusoutput("python3 trace.py flipCoin 1000 " + AP + " trace.txt")
		#s2 = subprocess.getstatusoutput("python3 trace.py flipCoinChange 100 " + AP + " trace.txt")
		#s2 = subprocess.getstatusoutput("python3 trace.py bernouilli 0.1 100 " + AP + " trace.txt")
